  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-6">
      ...
      <div className="space-y-6 text-slate-700 text-sm md:text-base leading-relaxed">
        <p>
          Welcome to <strong>MCJP.io</strong>. These terms and conditions outline the rules and regulations for the use of MCJP.io's Website, located at <strong>https://mcjp-blog-git-main-mcjp.vercel.app</strong>.
        </p>
        <p>
