  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-6">
      ...
      <div className="space-y-6 text-zinc-300 text-sm md:text-base leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#f4f4f5] mt-8">1. License</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[#f4f4f5] mt-8">2. Disclaimer of Financial/Legal Advice</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[#f4f4f5] mt-8">3. Hyperlinking to our Content</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[#f4f4f5] mt-8">4. Reservation of Rights</h2>
        <p>
          We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amend these terms and conditions and its linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
        </p>

        <h2 className="text-xl font-semibold text-[#f4f4f5] mt-8">5. Disclaimer of Liability</h2>
        <p>
