  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-6">
      ...
      <div className="space-y-6">
        <div className="p-6 rounded-lg border border-[#27272a] bg-[#09090b]/50 space-y-4">
          <div className="space-y-1">
            <h3 className="font-semibold text-[#f4f4f5]">Direct Email</h3>
            <p className="text-sm text-zinc-400">
              For general inquiries, editorial feedback, or advertising options:
            </p>
            <a href="mailto:contact@mcjp.io" className="text-amber-500 hover:underline text-sm font-medium">
              contact@mcjp.io
            </a>
          </div>
        </div>
        ...
        <form className="space-y-4 pt-4" onSubmit={(e) => e.preventDefault()}>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <input
                ...
                id="name"
                required
                className="w-full bg-[#18181b] border border-[#27272a] rounded px-4 py-2.5 text-sm text-[#f4f4f5] focus:outline-none focus:border-amber-500 transition-colors"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              required
              rows={5}
              className="w-full bg-[#18181b] border border-[#27272a] rounded px-4 py-2.5 text-sm text-[#f4f4f5] focus:outline-none focus:border-amber-500 transition-colors resize-none"
              placeholder="Your message details..."
            />
          </div>
          <button
            type="submit"
            className="px-6 py-2.5 rounded bg-amber-500 text-black font-semibold text-sm hover:bg-amber-400 transition-colors cursor-pointer"
          >
            Send Message
          </button>
        </form>
