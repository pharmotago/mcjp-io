  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-6">
      ...
      <div className="space-y-6 text-slate-700 text-sm md:text-base leading-relaxed">
        <p>
          At <strong>MCJP.io</strong>, accessible from <strong>https://mcjp-blog-git-main-mcjp.vercel.app</strong>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by MCJP.io and how we use it.
        </p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">2. Cookies and Web Beacons</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">3. Google DoubleClick DART Cookie</h2>
        <p>
          Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:underline">https://policies.google.com/technologies/ads</a>.
        </p>

        <h2 className="text-xl font-semibold text-slate-900 mt-8">4. Our Advertising Partners</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">5. Third-Party Privacy Policies</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">6. GDPR Data Protection Rights</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">7. Consent</h2>
        <p>
