    ...
    <div className="max-w-3xl mx-auto space-y-8 py-6">
      ...
      <div className="space-y-6 text-zinc-300 leading-relaxed">
        ...
        <div className="grid gap-6 md:grid-cols-3 mt-8">
          <div className="p-5 rounded-lg border border-[#27272a] bg-[#09090b]/50 space-y-2">
            <h3 className="font-semibold text-amber-500 text-lg">Money</h3>
          ...
          <div className="p-5 rounded-lg border border-[#27272a] bg-[#09090b]/50 space-y-2">
            <h3 className="font-semibold text-amber-500 text-lg">Life</h3>
            <p className="text-xs text-zinc-400">
          ...
          <div className="p-5 rounded-lg border border-[#27272a] bg-[#09090b]/50 space-y-2">
            <h3 className="font-semibold text-amber-500 text-lg">Discipline</h3>
            <p className="text-xs text-zinc-400">
        ...
        <h2 className="text-2xl font-semibold text-[#f4f4f5] mt-10">Our Editorial Philosophy</h2>
        <p>
